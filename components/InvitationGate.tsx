...
export function InvitationGate({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      ...
      >
        <img
          src="/images/envelope-only.webp"
          alt=""
          className="mx-auto w-full origin-center drop-shadow-[0_16px_24px_rgba(74,18,18,0.16)] transition-transform duration-500 ease-out group-hover:-translate-y-3 group-hover:scale-105 group-hover:-rotate-2"
        />
